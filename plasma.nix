{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-8a6b954d-cbac-453a-af72-e63d34c96018" = [];
      "ActivityManager"."switch-to-activity-d7b3cf7b-f551-451e-9078-35cfbe2e01f8" = [];
      ...
      "kmix"."decrease-volume-Capture 2@HDA Intel PCH" = [];
      "kmix"."decrease-volume-Capture@HDA Intel PCH" = [];
      "kmix"."decrease-volume-Center@HDA Intel PCH" = [];
      "kmix"."decrease-volume-Front Mic Boost@HDA Intel PCH" = [];
      "kmix"."decrease-volume-Front Mic@HDA Intel PCH" = [];
      "kmix"."decrease-volume-Front@HDA Intel PCH" = [];
      "kmix"."decrease-volume-Headphone@HDA Intel PCH" = [];
      "kmix"."decrease-volume-LFE@HDA Intel PCH" = [];
      "kmix"."decrease-volume-Line Boost@HDA Intel PCH" = [];
      "kmix"."decrease-volume-Line@HDA Intel PCH" = [];
      "kmix"."decrease-volume-Master@HDA Intel PCH" = [];
      "kmix"."decrease-volume-PCM@HDA Intel PCH" = [];
      "kmix"."decrease-volume-Rear Mic Boost@HDA Intel PCH" = [];
      "kmix"."decrease-volume-Rear Mic@HDA Intel PCH" = [];
      "kmix"."decrease-volume-Speaker@Razer Kraken V3 X" = [];
      "kmix"."decrease-volume-Surround@HDA Intel PCH" = [];
      "kmix"."decrease_microphone_volume" = "Microphone Volume Down";
      "kmix"."decrease_volume" = "Volume Down";
      "kmix"."decrease_volume_small" = "Shift+Volume Down";
      "kmix"."increase-volume-Capture 2@HDA Intel PCH" = [];
      "kmix"."increase-volume-Capture@HDA Intel PCH" = [];
      "kmix"."increase-volume-Center@HDA Intel PCH" = [];
      "kmix"."increase-volume-Front Mic Boost@HDA Intel PCH" = [];
      "kmix"."increase-volume-Front Mic@HDA Intel PCH" = [];
      "kmix"."increase-volume-Front@HDA Intel PCH" = [];
      "kmix"."increase-volume-Headphone@HDA Intel PCH" = [];
      "kmix"."increase-volume-LFE@HDA Intel PCH" = [];
      "kmix"."increase-volume-Line Boost@HDA Intel PCH" = [];
      "kmix"."increase-volume-Line@HDA Intel PCH" = [];
      "kmix"."increase-volume-Master@HDA Intel PCH" = [];
      "kmix"."increase-volume-PCM@HDA Intel PCH" = [];
      "kmix"."increase-volume-Rear Mic Boost@HDA Intel PCH" = [];
      "kmix"."increase-volume-Rear Mic@HDA Intel PCH" = [];
      "kmix"."increase-volume-Speaker@Razer Kraken V3 X" = [];
      "kmix"."increase-volume-Surround@HDA Intel PCH" = [];
      "kmix"."increase_microphone_volume" = "Microphone Volume Up";
      "kmix"."increase_volume" = "Volume Up";
      "kmix"."increase_volume_small" = "Shift+Volume Up";
      "kmix"."mic_mute" = ["Microphone Mute" "Meta+Volume Mute,Microphone Mute" "Meta+Volume Mute,Mute Microphone"];
      "kmix"."mute" = "Volume Mute";
      "kmix"."toggle-mute-Capture 2@HDA Intel PCH" = [];
      "kmix"."toggle-mute-Capture@HDA Intel PCH" = [];
      "kmix"."toggle-mute-Center@HDA Intel PCH" = [];
      "kmix"."toggle-mute-Front Mic Boost@HDA Intel PCH" = [];
      "kmix"."toggle-mute-Front Mic@HDA Intel PCH" = [];
      "kmix"."toggle-mute-Front@HDA Intel PCH" = [];
      "kmix"."toggle-mute-Headphone@HDA Intel PCH" = [];
      "kmix"."toggle-mute-IEC958 2@HDA NVidia" = [];
      "kmix"."toggle-mute-IEC958 3@HDA NVidia" = [];
      "kmix"."toggle-mute-IEC958 4@HDA NVidia" = [];
      "kmix"."toggle-mute-IEC958 Default PCM@HDA Intel PCH" = [];
      "kmix"."toggle-mute-IEC958@HDA Intel PCH" = [];
      "kmix"."toggle-mute-IEC958@HDA NVidia" = [];
      "kmix"."toggle-mute-LFE@HDA Intel PCH" = [];
      "kmix"."toggle-mute-Line Boost@HDA Intel PCH" = [];
      "kmix"."toggle-mute-Line@HDA Intel PCH" = [];
      "kmix"."toggle-mute-Master@HDA Intel PCH" = [];
      "kmix"."toggle-mute-PCM@HDA Intel PCH" = [];
      "kmix"."toggle-mute-Rear Mic Boost@HDA Intel PCH" = [];
      "kmix"."toggle-mute-Rear Mic@HDA Intel PCH" = [];
      "kmix"."toggle-mute-Speaker@Razer Kraken V3 X" = [];
      "kmix"."toggle-mute-Surround@HDA Intel PCH" = [];
      ...
      "kwin"."Window Close" = "Alt+Esc,Alt+F4,Close Window";
    ...
    configFile = {
      ...
      "dolphinrc"."General"."ViewPropsTimestamp" = "2024,2,14,20,25,21.63";
      "dolphinrc"."KFileDialog Settings"."Places Icons Auto-resize" = false;
      "dolphinrc"."KFileDialog Settings"."Places Icons Static Size" = 22;
      "kactivitymanagerdrc"."activities"."d7b3cf7b-f551-451e-9078-35cfbe2e01f8" = "Default";
      "kactivitymanagerdrc"."main"."currentActivity" = "d7b3cf7b-f551-451e-9078-35cfbe2e01f8";
      ...
      "katerc"."KTextEditor::Search"."Search History" = "File,cp,BurpSuit,BurpSuiteCrack,/Form,form,URI,Filter,.jar,.java,Filter.java,filter,china,cn,cn\s";
      ...
      "kcminputrc"."Mouse"."cursorTheme" = "Vivid-Dark-Icons";
      ...
      "kdeglobals"."Icons"."Theme" = "Vivid-Dark-Icons";
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{1fdebd9c-b096-4a52-96f8-805635305bd2}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{e41ac5f1-1cf4-4092-b768-197fbe06f606}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{3094314a-9657-4305-b3c6-b1a7cf998ede}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{c1ef25fb-35b2-4443-8f34-f88510002e54}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{30ae6ff2-bb7d-478c-9b65-b66708c37ffc}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{72de3d1f-36c8-4b66-8a39-da0db6bbda48}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{64ca747e-6657-4b27-9fcc-ce24ecf998c6}";
      ...
      "kwinrc"."Desktops"."Id_1" = "b1f6f18f-e6c8-4b8d-b63a-22d13ef65a37";
      "kwinrc"."Desktops"."Id_2" = "290db5b7-8ce9-4588-99a4-ca049db44bc4";
      "kwinrc"."Desktops"."Id_3" = "1cc10e73-9a97-45ef-9fc1-bcda9afafd66";
      "kwinrc"."Desktops"."Id_4" = "5c3bea8b-288f-4fcf-bb55-a344f982492d";
      ...
      "kwinrc"."Tiling/0c110d60-6bb9-5851-9292-fd8027aacf61"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/24e4d52f-5d47-5dec-8bcd-0af243f067e7"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling/8ecd81ab-323c-57bb-b4f6-a153aa031576"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling/a4548671-9945-52fa-9a1c-fcbf0d00f2b6"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "plasmarc"."Theme-plasmathemeexplorer"."name" = "Vivid-Dark-Plasma";
      "plasmarc"."Wallpapers"."usersWallpapers" = "";
      "spectaclerc"."ImageSave"."translatedScreenshotsFolder" = "Screenshots";
      "spectaclerc"."VideoSave"."translatedScreencastsFolder" = "Screencasts";
    };
    dataFile = {
      "kate/anonymous.katesession"."Document 0"."URL" = "file:///home/matt/Downloads/LinuxPC-Exports/kitty.conf";
      ...
      "kate/anonymous.katesession"."MainWindow0"."Kate-MDI-Sidebar-3-Splitter" = 1630;
      ...
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Active View" = "file:///home/matt/Downloads/LinuxPC-Exports/kitty.conf";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Count" = 1;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."Documents" = "file:///home/matt/Downloads/LinuxPC-Exports/kitty.conf";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0"."View 0" = "file:///home/matt/Downloads/LinuxPC-Exports/kitty.conf";
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/matt\\/Downloads\\/LinuxPC-Exports\\/kitty.conf"."CursorColumn" = 0;
      "kate/anonymous.katesession"."MainWindow0-ViewSpace 0 file:\\/\\/\\/home\\/matt\\/Downloads\\/LinuxPC-Exports\\/kitty.conf"."CursorLine" = 23;
